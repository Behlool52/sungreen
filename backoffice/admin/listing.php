          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">All Pages
                  ...
                  <div class="table-responsive noSwipe">
                    <table class="table table-striped table-hover">
                      ...
                      <tr>
                        ...
                        <th style="width:17%;">Page Slug</th>
					  ...
					  <tr>
                        ...
                        <td class="actions">
                          <a href="pagedit.php?pageid=<?php echo $pagerow['id']; ?>" class="icon"><i class="mdi mdi-edit"></i></a>
                           <a href="pagedel.php?pageid=<?php echo $pagerow['id']; ?>" class="icon"><i class="mdi mdi-close-circle-o text-danger"></i></a>
                        </td>
                      </tr>
					<?php } ?>  
