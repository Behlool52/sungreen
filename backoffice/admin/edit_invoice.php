          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body modifyinvoice">
                 
					

					
					
 <form action="" method="post" id="edit_invoice" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
           ...
           <select class="form-control input-xs" id="customer_idd">
			   ...
			   ?>
			    <option value="<?php echo $cust['id']; ?>" <?php if($cust['id']==$invorowsw[2]){?>selected<?php }?> ><?php echo $cust['first_name']; ?></option>
			   <?php } ?>
      ...
      <div id="primary-content" class="primary-content">
        <div class="form-group row">
          ...
          <div class="col-md-4 table-container">
            <input type="text"  class="form-control input-xs" id="invoice_no" value="<?php echo $invorowsw[3]; ?>">
			  <input type="hidden" id="idd" value="<?php echo $invorowsw[0]; ?>">
			   <input type="hidden" id="orginvo" value="<?php echo $invorowsw[3]; ?>">
          </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-4">
                  ...
                  <select class="form-control input-xs" id="payment_mode">
                      ...
                      <option value="cash" <?php if($invorowsw[4]=='cash'){?> selected <?php } ?>>Cash</option>
                      <option value="company_finance" <?php if($invorowsw[4]=='company_finance'){?> selected <?php } ?>>Company Finance</option>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-4">
                  <input type="text" class="form-control input-xs" id="finance_company" <?php if($invorowsw[24]!=''){?> value="<?php echo $invorowsw[24]; ?>"<?php }?>>
              </div>
          </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-4">
                  ...
                  <select class="form-control input-xs" id="stc_platform">
                      ...
                      <option value="">Select Payment Mode</option>
                      <option value="green_deal" <?php if($invorowsw[25]=='green_deal'){?> selected <?php } ?>>Green Deal</option>
                      <option value="achievers_energy" <?php if($invorowsw[25]=='achievers_energy'){?> selected <?php } ?>>Achievers Energy</option>
                      <option value="emerging_energy" <?php if($invorowsw[25]=='emergying_energy'){?> selected <?php } ?>>Emerging Energy</option>
          ...
          <div class="form-group row">
          <label class="control-label col-md-2">Application No.</label>
          <div class="col-md-4">
            
			   <input type="text" class="form-control input-xs" id="application_number" value="<?php echo $invorowsw[23]; ?>">
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-md-4">
			  ...
			  <div data-min-view="2" data-date-format="yyyy-mm-dd" class="input-group date datetimepicker">
                  <input type="text" class="form-control input-xs" id="invoice_date" value="<?php echo $invorowsw[6]; ?>">
				  <span class="input-group-addon btn"><i class="icon-th mdi mdi-calendar"></i></span>
                        </div>
		  ...
		  <div class="form-group row" style="background:#efefef; margin:0px;">
           ...
           <select class="form-control input-sm" id="lead_person">
			   ...
			   ?>
                           <option value="<?php echo $elecperson['id']; ?>" <?php if($elecperson['id']==$invorowsw[9]){?>selected<?php }?>><?php echo $elecperson['name']; ?></option>
                         <?php }?>
                        </select>
          </div>
           ...
           <select class="form-control input-sm" id="sale_person">
               ...
               while($elecperson = mysql_fetch_array($elecque)){
			   ?>
                           <option value="<?php echo $elecperson['id']; ?>" <?php if($elecperson['id']==$invorowsw[10]){?>selected<?php }?>><?php echo $elecperson['name']; ?></option>
                         <?php }?>
                        </select>			   
           ...
           <select class="form-control input-sm" id="electrician">
               ...
               while($elecperson = mysql_fetch_array($elecque)){
			   ?>
                           <option value="<?php echo $elecperson['id']; ?>" <?php if($elecperson['id']==$invorowsw[11]){?>selected<?php }?>><?php echo $elecperson['name']; ?></option>
                         <?php }?>
                        </select>			   
			   ...
			   <div class="col-md-1">
				  ...
				  <div class="btn-group btn-hspace workorderform">
                      ...
                      <ul role="menu" class="dropdown-menu">
                        <li><a href="#" data-toggle="modal" data-target="#form-bp1" id="<?php echo $invorowsw[3]; ?>" class="workorderfetch">Work Order</a></li>

						<?php if($invorowsw[25]=='green_deal'){ ?>
                          <li id="greendeal"><a href="#" data-toggle="modal" data-target="#pobox" id="<?php echo $invorowsw[3]; ?>" class="greendealfetch">Greendeal</a></li>
						<?php }?>
						<?php if($invorowsw[25]=='achievers_energy'){ ?>
                          <li id="achievers"><a href="#" data-toggle="modal" data-target="#pobox2" id="<?php echo $invorowsw[3]; ?>" class="achieversfetch">Achievers</a></li>
						  <?php }?>
                          <li id="emerging"><a href="#" data-toggle="modal" data-target="#form-bp4" id="<?php echo $invorowsw[3]; ?>" class="stcfetch">STC</a></li>
		 ...
		 <button type="button" data-dismiss="modal" aria-hidden="true" class="close md-close"><span class="mdi mdi-close"></span></button>
          ...
          <div class="modal-body">
           ...
           <div class="">
                ...
                <input type="hidden" id="deal_invoice" class="form-control input-xs" value="<?php echo $invorowsw[3]; ?>">
           </div>
           <br><br>
...
<!-- End PO Popup -->                    
					...
					<!--
					<a href="#" aria-expanded="false" data-toggle="dropdown" data-target="#form-bp1" id="" class="btn btn-space btn-default hover workorderform dropdown-toggle">
						
					<i class="icon icon-left mdi mdi-assignment-o"></i> 
...
<!-- popup 1 end-->
                   ...
                   <div id="pobox2" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary emailcombo">
					   <form id="frm_<?php echo $invorowsw[3]; ?>" action="" name="<?php echo $invorowsw[3]; ?>">
                       <div class="modal-dialog custom-width">
                           <div class="modal-content work_order_content">
                               <div class="modal-header">
                               ...
                               <div class="modal-body">
                                   ...
                                   <div class="">
                                       ...
                                       <div class="col-md-12 table-container">
                                           <input type="text" placeholder="ID" class="form-control input-xs" id="poidd">
                                       ...
                                       <div class="">
                                           ...
                                           <div class="col-md-12 table-container">
                                               <input type="text" placeholder="Reference No." class="form-control input-xs" id="reference_noo">
                                           </div>
		 ...
		 <button type="button" data-dismiss="modal" aria-hidden="true" class="close md-close"><span class="mdi mdi-close"></span></button>
          ...
          <div class="modal-body">
			  ...
			  <div class="col-md-12">
                  ...
                  <div class="stcaddress">Emerging Energy Solutions Group Pty Ltd. Level 51, 360 Elizabeth Street, Melbourne Vic 3000
				</div>
                ...
                <div class="hdstyler">Owner Details</div>
                    ...
                    <div>	
						    ...
						    <input type="hidden" id="stc_invoice" value="<?php echo $invorowsw[3]; ?>" class="form-control input-xs">
                    </div>
                    <div>	
                ...
                <strong>STC Deeming Period:</strong>                       
                        <div class="be-checkbox inline">
                          <input id="one_year" type="checkbox" value="1" <?php if($invorowsw[19]==1){?> checked <?php }?>>
                          <label for="one_year">1 Yr</label>
                        </div>
                        <div class="be-checkbox inline" style="margin-left:0px;">
                          <input id="five_years" type="checkbox" value="1" <?php if($invorowsw[20]==1){?> checked <?php }?>>
                          <label for="five_years">5 Yrs</label>
                        </div>
                         <div class="be-checkbox inline" style="margin-left:0px;">                          
                          <input id="fourteen_years" type="checkbox" value="1" <?php if($invorowsw[21]==1){?> checked <?php }?>>
                ...
                <div class="col-md-6">
                 ...
                 <div>
					...
					I understand that this system is eligible for <input type="text" id="stc_eligible" class="inputnobdr">  STCs and in exchange for assigning my right to create these STCs, I will receive a point of sale discount from the installers/suppliers.	
                     ...
                     <div style="margin:20px 0px 20px 0px; overflow:auto;">
					<div class="col-md-12"> 
                    <input type="text" placeholder="Owner Signature" id="owner_signature" class="col-md-8 input-xs inputnobdr">
                    <input type="text" placeholder="Date" id="owner_signature_date" class="col-md-4 input-xs inputnobdr">
						 </div>
						 <div class="col-md-12"> 
                    <input type="text" placeholder="Agent/Installer Sign" id="agent_signature" class="col-md-8 input-xs inputnobdr">
                    <input type="text" placeholder="Date" id="agent_signature_date" class="col-md-4 input-xs inputnobdr">
							  </div>
                    </div>
...
-->
    ...
    <div class="table-repsonsive">
     ...
     <table class="table table-bordered" id="item_table">
       ...
       <th width="5%"><button type="button" name="add" id="<?php echo $invorowsw[3]; ?>" class="mdi mdi-plus-square add2"></button></th>
			<input type="hidden" id="onlyinvoiceid" value="<?php echo $invorowswpp; ?>">
      </tr> 
        ...
        $invocount = mysql_num_rows($invoproque);
        $ji= 1;
	...
	$sj = $ji++;
		 ...
		 ?>
  							...
  							<td>
								...
								<select name="product_name[]" id="product_<?php echo $sj; ?>" onchange="checkprod(this.id, <?php echo $sj; ?>)" class="abc form-control item_unit input-xs">
									<option value="" >Select Unit</option>
									<?php echo fill_unit_select_box_2($row['product_id']); ?>
								</select></td>
                                <td><input value="<?php echo $row['product_desc']; ?>" type="text" id="desc_<?php echo $sj; ?>" name="desc[]" class="form-control item_name input-xs" /></td>
  							<td><input value="<?php echo $row['product_qty']; ?>" type="text" id="qty_<?php echo $sj; ?>" onblur="checkid(this.id, <?php echo $sj; ?>)" name="product_qty[]" class="form-control item_name input-xs" /></td>
  							<td><input type="text" id="rate_<?php echo $sj; ?>" onblur="checkidrt(this.id, <?php echo $sj; ?>)" value="<?php echo $row['product_rate']; ?>" name="product_rate[]" class="form-control item_rate input-xs"/></td>
								
								
								
								<td><select name="gst[]" id="gst_<?php echo $sj; ?>" class="form-control item_unit input-xs"><option value="none">Select Unit</option><option value="yes" <?php if($row['gst']=='yes'){?> selected <?php }?>   >Yes</option><option value="no" <?php if($row['gst']=='no'){?> selected <?php }?>>No</option></select></td>
								
								
								
								
								
  							<td><input type="text" value="<?php echo $row['product_discount']; ?>" name="product_discount[]" class="form-control item_rate input-xs" /></td>     		 
  							<td><input type="text" value="<?php echo $row['total_amount']; ?>" id="amount_<?php echo $sj; ?>" name="product_amount[]" class="form-control item_amount input-xs" /></td>
  ...
  <div class="total-row sub-total">
    <div class="total-label">Sub Total
      <br>
<!---->    </div>
    <div class="total-amount" id="subtotal"><?php echo $invorowsw[12]; ?></div>
  </div>
...
<!---->
  <div class="total-row gross-total ">
    ...
    <div class="total-amount" id="total"><?php echo $invorowsw[13]; ?>
    ...
    <div class="fill-container txn-bottom-form grey-bg">
      ...
      <div class="modal-dialog custom-width">
		...
		<div class="form-group col-md-12">
          ...
          <div class="modal-footer">
            <button type="button" data-dismiss="modal" class="btn btn-default md-close">Cancel</button>
            <button type="submit" id="workordereditbtn" data-dismiss="modal" class="btn btn-primary md-close">Proceed</button>
          </div>
...
<div>
    ...
    <div class="zb-txn-form">
      ...
      <div class="btn-toolbar fixed-actions fill-container">
        <div class="btn-group ">
          <button type="submit" id="save_invoice" class="btn btn-default ember-view"> Update Invoice </button>
        </div>
