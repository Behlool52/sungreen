...
<?php include 'includes/leftpanel.php'; ?> 
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Add Sale Person</h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading panel-heading-divider">Add Sale Person</div>
                <div class="panel-body">
                 <form action="#" method="post" id="saleperson" style="border-radius: 0px;" class="form-horizontal group-border-dashed adduser">
