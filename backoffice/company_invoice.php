...
<!---->          </div>
  ...
  <div class="secure-band">
        <div class="center-container actions">
            <div class="hidden-xs">
							<h3 style="margin: 5px 0 0;"><strong>$<?php echo $totalinvoicepayment = $invorowsw[13]-$invorowsw[15];
				//echo $invorowsw[14];
				?>
			  ...
			  <table style="font-size:13px; float:right;width: 60%;table-layout: fixed;word-wrap: break-word;" border="0" cellspacing="0" cellpadding="0" >
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-align-right">
                            <span id="tmp_due_date"><?php echo $invorowsw[24];?></span>
                        </td>
                    </tr>
...
//echo '<br>';
          ...
          <tr>
            <td class="total-section-label text-align-right"><b>Total (inc-GST)</b></td>
          ...
          <tr style="height:40px;" class="pcs-balance">
            ...
            <td id="tmp_balance_due" class="total-section-value text-align-right"><b>$<?php echo $totalinvoicepayment = $invorowsw[13]-$invorowsw[15];
				//echo $invorowsw[14];
				?>
				</b></td>
          </tr>
    ...
    padding-bottom: 10px;
    text-align: center;
    font-size: 1em;" class="pcs-notes"></p>
		...
		<tr>
			...
			<td width="33%" class="pcs-totals" align="center" style="padding:20px; font-size:1.5em; border-right:1px dashed #ccc; text-transform:capitalize;"  valign="top">
				<?php echo $invorowsw[24];?>
			</td>
			<td width="33%" class="pcs-totals" align="center" style="padding:20px; border-right:1px dashed #ccc;"  valign="top">
				Invoice #<?php echo $invorowsw[3];?>
				
				
				</td>
			<td width="33%" class="pcs-totals" align="center" style="padding:20px;" valign="top">
				Amount Due: $<?php echo $invorowsw[14];?>
			</td>
			</tr>
			
			<tr>
			
			<td colspan="2" valign="middle" width="66%" class="pcs-totals" align="center" style="padding:10px; border-right:1px dashed #ccc;"  valign="top">
				I CONFIRM THE ABOVE GOODS HAVE BEEN RECEIVED AND INSTALLED
			</td>
			
			<td width="33%" class="pcs-totals" align="center" style="padding:20px;" valign="top">
				<table width="100%" cellpadding="8" class="pcs-totals">
					<tr>
						<td>Signed______________________</td>
					</tr>
					<tr>
						<td>Date_______________________</td>
					</tr>
				</table>
